...
// Returns "<full-id>\t<repo:tag or <none>>\t<size>\t<age>" for every image on the host,
// including dangling (untagged) ones. IDs are full (--no-trunc) so they can be diffed
// against listInUseImageIds below.
